...
//    var drache3 = Dragon()
    ...
    fun kampfBeginnt() {
                ...
                if (dragonHP1 > 0 || magier.hp > 0 || ritter.hp > 0 || moench.hp > 0) {
                    if (!magier.betaeubt) {
                        if (dragonHP1 > 0 && magier.hp > 0) {
                            ...
                            if (dragonHP1 <= 0) {
                                dragonHP1 = 0.0
                                println("${drache1.name} ist tot (${dragonHP1} HP)")
                                dragonLostStufe1()
                            }
                        }
                    } else {
        ...
        if (inputSchwierigkeitsstufeGegener == "2") {
            if (dragonHP1 > magier.hp && dragonHP1 > ritter.hp && dragonHP1 > moench.hp) {
                heroesLostStufe2()
            } else if (dragonHP1 < magier.hp && dragonHP1 < ritter.hp && dragonHP1 < moench.hp) {
                dragonLostStufe1()
            ...
            when (ritterFaehigkeitInput) {
                "1" -> {
                    if (ritter.zustandSchutzSchild > 0) {
                        ...
                        if (!ritter.schutzschildGezogen) {
                            ...
                            println("${ritter.name} hat bereits sein Schutzschild gezogen. Abklingdauer noch ${ritter.schutzSchildAbklingdauer} Runde(n), Zustand ${ritter.zustandSchutzSchild}/5!")
                ...
                "2" -> {
                    if (ritter.abklingzeitHarterSchlag == 0 && ritter.harterSchlagVerfügbar) {
                        ...
                        println("${ritter.name} wollte seinen harten Schlag einsetzen. Dieser hat aber noch ${ritter.abklingzeitHarterSchlag} Runde(n) Abklingzeit.")
                        println("Deshalb setzt ${ritter.name} seinen normalen Angriff ein und macht ${drache1.name} ${ritter.schaden} Schaden.")
                        dragonHP1 = dragonHP1 - ritter.schaden
                    }
    ...
    fun drachenAngriffStufe1() {
            ...
            if (!klon1.einsetzbar) {
                ...
                if (ritter.hp > 0) {
                    ...
                    if (ritter.schutzschildGezogen) {
                        ...
                        println("Zustand Schutzschild ${ritter.zustandSchutzSchild}/5")
                        if (ritter.zustandSchutzSchild == 0) {
                            ritter.schutzSchildNutzbarkeit = false
        ...
        if (randomDrachenAngriff == drache1.faehigkeiten[3]) {
            ...
            if (randomHeld == "Magier") {
                ...
                println("Mönch HP: ${moench.hp} (-${moench.fuenfProzent} HP) vs. Drachen HP: ${dragonHP1} (+${moench.fuenfProzent} HP)")
            }
        }
            ...
            do {
                ...
                when (randomHeldFeuerBaelle) {
                    ...
                    "Ritter" -> {
                        verursachterSchaden = drache1.feuerRegenSchaden.toDouble()
                        ritter.hp = ritter.hp - verursachterSchaden
                        println("Ritter HP: ${ritter.hp} (-${verursachterSchaden} HP) vs. Drache HP: ${dragonHP1}")
                    }

                    "Mönch" -> {
                        verursachterSchaden = drache1.feuerRegenSchaden.toDouble()
                        moench.hp = moench.hp - verursachterSchaden
                        println("Mönch HP: ${moench.hp} (-${verursachterSchaden} HP) vs. Drache HP: ${dragonHP1}")
                    }
        ...
        if (moenchFaehigkeitInput == "1" || moenchFaehigkeitInput == "2" || moenchFaehigkeitInput == "3") {
            when (moenchFaehigkeitInput) {
                ...
                "2" -> {
                    if (moench.selbstHeilungNutzbarkeit) {
                        moench.selbstHeilungNutzbarkeit = false
                        var selbstHeilung = moench.hp * 0.05
                        println("${moench.name} setzt seine Selbstheilungskräfte ein und erhält +${selbstHeilung} HP.")
                        moench.hp = moench.hp + selbstHeilung
                    } else {
                        println("${moench.name} wollte sich selbst heilen. Diese Fähigkeit wurde aber bereits verwendet.")
    ...
    fun drachenAngriffStufe2() {
        ...
        if (randomDrachenAngriff == drache2.faehigkeiten[0]) {
            if (!klon2.einsetzbar) {
                println("${drache2.name} wollte seinen Klon heraufbeschwören, dieser war aber schon im Einsatz.")
                return drachenAngriffStufe2()
            } else {
                println("${drache2.name}'s Klon erscheint...")
                klon2.einsetzbar = false
                if (magier.hp > 0) {
                    println("Magier HP: ${magier.hp} vs. Drachen HP: ${dragonHP2} & Klon HP: ${dragonKlonHP2}")
                ...
                if (ritter.hp > 0) {
                    println("Ritter HP: ${ritter.hp} vs. Drachen HP: ${dragonHP2} & Klon HP: ${dragonKlonHP2}")
                    println("\nDer Drache greift mit einem Schaden von ${dragonSchaden2} an.")
                    println("Sein Klon greift mit einem Schaden von ${dragonKlonSchaden2} an.")
                    if (ritter.schutzschildGezogen) {
                        println("Die Angriffe vom Drachen und seinem Klon sind an ${ritter.name}'s Schutzschild abgeprallt")
                ...
                if (moench.hp > 0) {
                    println("Mönch HP: ${moench.hp} vs. Drachen HP: ${dragonHP2} & Klon HP: ${dragonKlonHP2}")
                    println("\nDer Drache greift mit einem Schaden von ${dragonSchaden2} an.")
                    println("Sein Klon greift mit einem Schaden von ${dragonKlonSchaden2} an.")
                    if (moench.schwebenAktiv) {
                        moench.schwebenAbklingdauer--
        ...
        if (randomDrachenAngriff == drache2.faehigkeiten[1]) {
            println("${drache2.name} setzt 'Flächenschaden' ein...")
            ...
            if (magier.hp > 0) {
                ...
                if (magier.schutzschildGezogen) {
                    ...
                    Thread.sleep(1000)
                    magier.hp = (magier.hp - verursachterSchaden)
                    println("Magier HP: ${magier.hp} (-${verursachterSchaden}) vs. Drachen HP: ${dragonHP2}\n")
                } else if (magier.doppelterSchadenEingesetzt) {
                    magier.doppelterSchadenNutzbarkeit = false
                    println("Weil ${magier.name} seine 'doppelter Schaden' Fähigkeit eingesetzt hat, würde der Drache seinen eingesetzten Schaden verdoppelt zurück erhalten.")
                    println("Dieser wirkt bei dieser Drachenfähigkeit aber nicht. ${drache2.name} macht deshalb ${magier.name} ${drache2.flaechenSchaden} Schaden.")
                    verursachterSchaden = drache2.flaechenSchaden.toDouble()
                    println("Magier HP: ${magier.hp} (-${verursachterSchaden}) vs. Drachen HP: ${dragonHP2}\n")
            ...
            if (ritter.hp > 0) {
                ...
                if (ritter.schutzschildGezogen) {
                    ...
                    Thread.sleep(1000)
                    ritter.hp = (ritter.hp - verursachterSchaden)
                    println("Ritter HP: ${ritter.hp} (-${verursachterSchaden}) vs. Drachen HP: ${dragonHP2}\n")
                }
            }
            if (moench.hp > 0) {
                println("\nMönch HP: ${moench.hp} vs. Drachen HP: ${dragonHP2}")
                if (moench.schwebenAktiv) {
                    println("Dank ${moench.name}'s eingesetzter Schwebefähigkeit, konnte ${drache2.name} keinen Schaden erwirken.")
                    println("Mönch HP: ${moench.hp} (-0) vs. Drachen HP: ${dragonHP2}\n")
                } else {
                    verursachterSchaden = drache2.flaechenSchaden.toDouble()
                    Thread.sleep(1000)
                    moench.hp = (moench.hp - verursachterSchaden)
                    println("Mönch HP: ${moench.hp} (-${verursachterSchaden}) vs. Drachen HP: ${dragonHP2}\n")
                }
            }
            if (magier.hp <= 0 && ritter.hp <= 0 && moench.hp <= 0) {
                heroesLostStufe2()
        ...
        if (randomDrachenAngriff == drache2.faehigkeiten[2]) {
            println("${drache2.name} setzt 'Feueratem' ein...")
            if (magier.hp > 0) {
                println("Magier HP: ${magier.hp} vs. Drachen HP: ${dragonHP2}")
                ...
                if (magier.schutzschildGezogen) {
                    ...
                    magier.doppelterSchadenNutzbarkeit = false
                    println("Weil ${magier.name} seine 'doppelter Schaden' Fähigkeit eingesetzt hat, würde der Drache seinen eingesetzten Schaden verdoppelt zurück erhalten.")
                    println("Dieser wirkt bei dieser Drachenfähigkeit aber nicht. ${drache2.name} macht deshalb ${magier.name} ${drache2.feuerAtemSchaden} Schaden.")
        ...
        if (randomDrachenAngriff == drache2.faehigkeiten[3]) {
            println("${drache2.name} hat seine HP-Klau Fähigkeit aktiviert und stielt einem zufälligen Helden 5% Gesamt-HP")
            Thread.sleep(1000)
            println("Drache wählt Held aus...")
            Thread.sleep(5000)
            if (randomHeld == "Magier") {
                ...
                println("Es wurden ${magier.name} 5% HP abgezogen und ${drache2.name} hinzugefügt.")
                println("Magier HP: ${magier.hp} (-${magier.fuenfProzent} HP) vs. Drachen HP: ${dragonHP2} (+${magier.fuenfProzent} HP)")
            } else if (randomHeld == "Ritter") {
                ritter.hp = ritter.hp - ritter.fuenfProzent
                dragonHP2 = dragonHP2 + ritter.fuenfProzent
                println("Es wurden ${ritter.name} 5% HP abgezogen und ${drache2.name} hinzugefügt.")
                println("Ritter HP: ${ritter.hp} (-${ritter.fuenfProzent} HP) vs. Drachen HP: ${dragonHP2} (+${ritter.fuenfProzent} HP)")
            } else {
                moench.hp = moench.hp - moench.fuenfProzent
                dragonHP2 = dragonHP2 + moench.fuenfProzent
                println("Es wurden ${moench.name} 5% HP abgezogen und ${drache2.name} hinzugefügt.")
                println("Mönch HP: ${moench.hp} (-${moench.fuenfProzent} HP) vs. Drachen HP: ${dragonHP2} (+${moench.fuenfProzent} HP)")
            }
        }
        if (randomDrachenAngriff == drache2.faehigkeiten[4]) {
            println("${drache2.name} setzt 'Stampfattacke' ein...")
            println("\nDer Drache greift mit einem Schaden von ${drache2.flaechenSchaden} an.")
            println("Zusätzlich betäubt er alle getroffenen Einheiten")
            if (magier.hp > 0) {
                println("Magier HP: ${magier.hp} vs. Drachen HP: ${dragonHP2}")
            ...
            if (moench.hp > 0) {
                ...
                if (moench.schwebenAktiv) {
                    ...
                    moench.betaeubt = true
                    Thread.sleep(1000)
                    println("Mönch HP: ${ritter.hp} (-${verursachterSchaden}) vs. Drachen HP: ${dragonHP2}\n")
                }
            }
            if (magier.hp <= 0 && ritter.hp <= 0 && moench.hp <= 0) {
                heroesLostStufe2()
        ...
        if (randomDrachenAngriff == drache2.faehigkeiten[5]) {
            ...
            println("${drache2.name} hat Feuerregen aktiviert und spuckt 5 Feuerbälle in die Luft.")
            println("Wer wohl getroffen wird...")
            Thread.sleep(1000)
            println("Drache spuckt Feuerbälle...")
            Thread.sleep(5000)
            do {
                ...
                when (randomHeldFeuerBaelle) {
                    "Magier" -> {
                        ...
                        magier.hp = magier.hp - verursachterSchaden
                        println("Magier HP: ${magier.hp} (-${verursachterSchaden} HP) vs. Drache HP: ${dragonHP2}")
                    }

                    "Ritter" -> {
                        verursachterSchaden = drache2.feuerRegenSchaden.toDouble()
                        ritter.hp = ritter.hp - verursachterSchaden
                        println("Ritter HP: ${ritter.hp} (-${verursachterSchaden} HP) vs. Drache HP: ${dragonHP2}")
                    }

                    "Mönch" -> {
                        verursachterSchaden = drache2.feuerRegenSchaden.toDouble()
                        moench.hp = moench.hp - verursachterSchaden
                        println("Mönch HP: ${moench.hp} (-${verursachterSchaden} HP) vs. Drache HP: ${dragonHP2}")
                    }
    ...
    fun drachenAngriffStufe3() {
        ...
        if (randomDrachenAngriff == drache3.faehigkeiten[0]) {
            if (!klon3.einsetzbar) {
                println("${drache3.name} wollte seinen Klon heraufbeschwören, dieser war aber schon im Einsatz.")
                return drachenAngriffStufe2()
            } else {
                println("${drache3.name}'s Klon erscheint...")
                klon3.einsetzbar = false
                if (magier.hp > 0) {
                    println("Magier HP: ${magier.hp} vs. Drachen HP: ${dragonHP3} & Klon HP: ${dragonKlonHP3}")
                    println("\nDer Drache greift mit einem Schaden von ${dragonSchaden3} an.")
                    println("Sein Klon greift mit einem Schaden von ${dragonKlonSchaden3} an.")
                    if (magier.schutzschildGezogen) {
                        println("Die Angriffe vom Drachen und seinem Klon sind an ${magier.name}'s Schutzschild abgeprallt")
                        magier.schutzschildGezogen = false
                        magier.unverwundbar = false
                        ...
                        println("\nMagier HP: ${magier.hp} (-0) vs. Drachen HP: ${dragonHP3} & Klon HP: ${dragonKlonHP3}")
                    } else if (magier.doppelterSchadenEingesetzt) {
                        magier.doppelterSchadenNutzbarkeit = false
                        println("Weil ${magier.name} seine 'doppelter Schaden' Fähigkeit eingesetzt hat, erhält der Drache seinen eingesetzten Schaden verdoppelt zurück.")
                        dragonHP3 = dragonHP3 - (dragonSchaden2 * 2)
                        println("\nMagier HP: ${magier.hp} (- 0) vs. Drachen HP: ${dragonHP3} (-${dragonSchaden2 * 2}) & Klon HP: ${dragonKlonHP3}")

                    } else {
                        verursachterSchaden = dragonSchaden3 + dragonKlonSchaden3
                        magier.hp = (magier.hp - verursachterSchaden)
                        Thread.sleep(1000)
                        println("\nMagier HP: ${magier.hp} (-${verursachterSchaden}) vs. Drachen HP: ${dragonHP3} & Klon HP: ${dragonKlonHP3}")

                    }
                }
                if (ritter.hp > 0) {
                    println("Ritter HP: ${ritter.hp} vs. Drachen HP: ${dragonHP3} & Klon HP: ${dragonKlonHP2}")
                    println("\nDer Drache greift mit einem Schaden von ${dragonSchaden2} an.")
                    println("Sein Klon greift mit einem Schaden von ${dragonKlonSchaden2} an.")
                    if (ritter.schutzschildGezogen) {
                        println("Die Angriffe vom Drachen und seinem Klon sind an ${ritter.name}'s Schutzschild abgeprallt")
                ...
                if (moench.hp > 0) {
                    println("Mönch HP: ${moench.hp} vs. Drachen HP: ${dragonHP3} & Klon HP: ${dragonKlonHP2}")
                    println("\nDer Drache greift mit einem Schaden von ${dragonSchaden2} an.")
                    println("Sein Klon greift mit einem Schaden von ${dragonKlonSchaden2} an.")
                    if (moench.schwebenAktiv) {
                        moench.schwebenAbklingdauer--
        ...
        if (randomDrachenAngriff == drache3.faehigkeiten[1]) {
            println("${drache3.name} setzt 'Flächenschaden' ein...")
            ...
            if (magier.hp > 0) {
                ...
                if (magier.schutzschildGezogen) {
                    ...
                    Thread.sleep(1000)
                    magier.hp = (magier.hp - verursachterSchaden)
                    println("Magier HP: ${magier.hp} (-${verursachterSchaden}) vs. Drachen HP: ${dragonHP3}\n")
                } else if (magier.doppelterSchadenEingesetzt) {
                    magier.doppelterSchadenNutzbarkeit = false
                    println("Weil ${magier.name} seine 'doppelter Schaden' Fähigkeit eingesetzt hat, würde der Drache seinen eingesetzten Schaden verdoppelt zurück erhalten.")
                    println("Dieser wirkt bei dieser Drachenfähigkeit aber nicht. ${drache3.name} macht deshalb ${magier.name} ${drache3.flaechenSchaden} Schaden.")
                    verursachterSchaden = drache3.flaechenSchaden.toDouble()
                    println("Magier HP: ${magier.hp} (-${verursachterSchaden}) vs. Drachen HP: ${dragonHP3}\n")
            ...
            if (ritter.hp > 0) {
                ...
                if (ritter.schutzschildGezogen) {
                    ...
                    Thread.sleep(1000)
                    ritter.hp = (ritter.hp - verursachterSchaden)
                    println("Ritter HP: ${ritter.hp} (-${verursachterSchaden}) vs. Drachen HP: ${dragonHP3}\n")
                }
            }
            if (moench.hp > 0) {
                println("\nMönch HP: ${moench.hp} vs. Drachen HP: ${dragonHP3}")
                if (moench.schwebenAktiv) {
                    println("Dank ${moench.name}'s eingesetzter Schwebefähigkeit, konnte ${drache3.name} keinen Schaden erwirken.")
                    println("Mönch HP: ${moench.hp} (-0) vs. Drachen HP: ${dragonHP3}\n")
                } else {
                    verursachterSchaden = drache3.flaechenSchaden.toDouble()
                    Thread.sleep(1000)
                    moench.hp = (moench.hp - verursachterSchaden)
                    println("Mönch HP: ${moench.hp} (-${verursachterSchaden}) vs. Drachen HP: ${dragonHP3}\n")
                }
            }
            if (magier.hp <= 0 && ritter.hp <= 0 && moench.hp <= 0) {
                heroesLostStufe3()
        ...
        if (randomDrachenAngriff == drache3.faehigkeiten[2]) {
            println("${drache3.name} setzt 'Feueratem' ein...")
            if (magier.hp > 0) {
                println("Magier HP: ${magier.hp} vs. Drachen HP: ${dragonHP3}")
                ...
                if (magier.schutzschildGezogen) {
                    ...
                    magier.doppelterSchadenNutzbarkeit = false
                    println("Weil ${magier.name} seine 'doppelter Schaden' Fähigkeit eingesetzt hat, würde der Drache seinen eingesetzten Schaden verdoppelt zurück erhalten.")
                    println("Dieser wirkt bei dieser Drachenfähigkeit aber nicht. ${drache3.name} macht deshalb ${magier.name} ${drache3.feuerAtemSchaden} Schaden.")
        ...
        if (randomDrachenAngriff == drache3.faehigkeiten[3]) {
            println("${drache3.name} hat seine HP-Klau Fähigkeit aktiviert und stielt einem zufälligen Helden 5% Gesamt-HP")
            Thread.sleep(1000)
            println("Drache wählt Held aus...")
            Thread.sleep(5000)
            if (randomHeld == "Magier") {
                ...
                println("Es wurden ${magier.name} 5% HP abgezogen und ${drache3.name} hinzugefügt.")
                println("Magier HP: ${magier.hp} (-${magier.fuenfProzent} HP) vs. Drachen HP: ${dragonHP3} (+${magier.fuenfProzent} HP)")
            } else if (randomHeld == "Ritter") {
                ritter.hp = ritter.hp - ritter.fuenfProzent
                dragonHP3 = dragonHP3 + ritter.fuenfProzent
                println("Es wurden ${ritter.name} 5% HP abgezogen und ${drache3.name} hinzugefügt.")
                println("Ritter HP: ${ritter.hp} (-${ritter.fuenfProzent} HP) vs. Drachen HP: ${dragonHP3} (+${ritter.fuenfProzent} HP)")
            } else {
                moench.hp = moench.hp - moench.fuenfProzent
                dragonHP3 = dragonHP3 + moench.fuenfProzent
                println("Es wurden ${moench.name} 5% HP abgezogen und ${drache3.name} hinzugefügt.")
                println("Mönch HP: ${moench.hp} (-${moench.fuenfProzent} HP) vs. Drachen HP: ${dragonHP3} (+${moench.fuenfProzent} HP)")
            }
        }
        if (randomDrachenAngriff == drache3.faehigkeiten[4]) {
            println("${drache3.name} setzt 'Stampfattacke' ein...")
            println("\nDer Drache greift mit einem Schaden von ${drache3.flaechenSchaden} an.")
            println("Zusätzlich betäubt er alle getroffenen Einheiten")
            if (magier.hp > 0) {
                println("Magier HP: ${magier.hp} vs. Drachen HP: ${dragonHP3}")
            ...
            if (moench.hp > 0) {
                ...
                if (moench.schwebenAktiv) {
                    ...
                    moench.betaeubt = true
                    Thread.sleep(1000)
                    println("Mönch HP: ${ritter.hp} (-${verursachterSchaden}) vs. Drachen HP: ${dragonHP3}\n")
                }
            }
            if (magier.hp <= 0 && ritter.hp <= 0 && moench.hp <= 0) {
                heroesLostStufe1()
        ...
        if (randomDrachenAngriff == drache3.faehigkeiten[5]) {
            ...
            println("${drache3.name} hat Feuerregen aktiviert und spuckt 5 Feuerbälle in die Luft.")
            println("Wer wohl getroffen wird...")
            Thread.sleep(1000)
            println("Drache spuckt Feuerbälle...")
            Thread.sleep(5000)
            do {
                ...
                when (randomHeldFeuerBaelle) {
                    "Magier" -> {
                        ...
                        magier.hp = magier.hp - verursachterSchaden
                        println("Magier HP: ${magier.hp} (-${verursachterSchaden} HP) vs. Drache HP: ${dragonHP3}")
                    }

                    "Ritter" -> {
                        verursachterSchaden = drache3.feuerRegenSchaden.toDouble()
                        ritter.hp = ritter.hp - verursachterSchaden
                        println("Ritter HP: ${ritter.hp} (-${verursachterSchaden} HP) vs. Drache HP: ${dragonHP3}")
                    }

                    "Mönch" -> {
                        verursachterSchaden = drache3.feuerRegenSchaden.toDouble()
                        moench.hp = moench.hp - verursachterSchaden
                        println("Mönch HP: ${moench.hp} (-${verursachterSchaden} HP) vs. Drache HP: ${dragonHP3}")
                    }
    ...
    fun dragonLostStufe1() {
        ...
        println("${heldenGesamtHP} vs. ${dragonHP1}")
        println()
